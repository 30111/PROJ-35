...
function setup() {
 ...
 // escreva um bloco de código correto para adicionar botão para cortar a corda
...
function draw() 
{
  ...
  if(collide(fruit,bunny,80)==true)
  {
   ...
   bubble.visible = false;
    ...
    fruit = null;
   //Código para alterar a animação de um coelho quando uma colisão com fruta e coelho é detectada.
